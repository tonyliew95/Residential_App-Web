namespace Nop.Plugin.Api.Constants
{
    public class Configurations
    {
        ...
        //public const int DefaultAccessTokenExpiration = 315360000 ;    //WilliamHo 20181109 set token age limit
        //public const int DefaultRefreshTokenExpiration = int.MaxValue; //WilliamHo 20181109 set token age limit
        // 86400 seconds = 1 day
        public const int DefaultAccessTokenExpiration = 86400;           //WilliamHo 20181109 set token age limit
        public const int DefaultRefreshTokenExpiration = 86400;          //WilliamHo 20181109 set token age limit
