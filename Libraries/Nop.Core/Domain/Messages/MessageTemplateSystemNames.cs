namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        #region "MSP"
        /// <summary>
        /// Represents system name of customer welcome message [ENGLISH]
        /// </summary>
        public const string CustomerAccountActivation = "MSP_Customer.AccountActivation.EN";//LeeChurn 20180810 MSP-26

        /// <summary>
        /// Represents system name of customer welcome message [CHINESE]
        /// </summary>
        public const string CustomerAccountActivationCN = "MSP_Customer.AccountActivation.CN"; //WilliamHo 20180908

        /// <summary>
        /// Represents system name of MSP forgot password message [ENGLISH]
        /// </summary>
        public const string MSP_CustomerChangeTrxPwdMessage = "MSP_Customer.ChangeTransactionPassword.EN";

        /// <summary>
        /// Represents system name of MSP forgot password message [CHINESE]
        /// </summary>
        public const string MSP_CustomerChangeTrxPwdMessageCN = "MSP_Customer.ChangeTransactionPassword.CN"; //WilliamHo 20180908

        /// <summary>
        /// Represents system name of MSP change password message [ENGLISH]
        /// </summary>
        public const string MSP_CustomerChangePasswordMessage = "MSP_Customer.ChangePassword.EN"; //wailiang 20180816 MSP-9

        /// <summary>
        /// Represents system name of MSP change password message [CHINESE]
        /// </summary>
        public const string MSP_CustomerChangePasswordMessageCN = "MSP_Customer.ChangePassword.CN"; //WilliamHo 20180908

        /// <summary>
        /// Represents system name of MSP UpdateEmail message [ENGLISH]
        /// </summary>
        public const string MSP_CustomerUpdateEmailAddressMessage = "MSP_Customer.UpdateEmailAddress.EN"; //LeeChurn 20180816 MSP-61

        /// <summary>
        /// Represents system name of MSP UpdateEmail message [CHINESE]
        /// </summary>
        public const string MSP_CustomerUpdateEmailAddressMessageCN = "MSP_Customer.UpdateEmailAddress.CN"; //WilliamHo 20180908

        /// <summary>
        /// Represents system name of MSP change security answer message [ENGLISH]
        /// </summary>
        public const string MSP_CustomerChangeSecurityAnswerMessage = "MSP_Customer.ChangeSecurityAnswer.EN"; //WilliamHo 20180822 MSP-8

        /// <summary>
        /// Represents system name of MSP change security answer message [CHINESE]
        /// </summary>
        public const string MSP_CustomerChangeSecurityAnswerMessageCN = "MSP_Customer.ChangeSecurityAnswer.CN"; //WilliamHo 20180908

        /// <summary>
        /// Represents system name of MSP Max Deposit Notification Message [ENGLISH]
        /// </summary>
        public const string MSP_DepositMaxDepositBal = "MSP_Deposit.MaxDepositBal.EN";  //RW 20180828 MSP-16

        /// <summary>
        /// Represents system name of MSP Max Deposit Notification Message [CHINESE]
        /// </summary>
        public const string MSP_DepositMaxDepositBalCN = "MSP_Deposit.MaxDepositBal.CN";  //RW 20180828 MSP-16

        //WilliamHo 20180908 Tony mentioned no longer need this function \/
        /*
        /// <summary>
        /// Represents system name of MSP forgot password message
        /// </summary>
        public const string MSP_CustomerPasswordRecoveryMessage = "MSP_Customer.PasswordRecovery";
        */
        //WilliamHo 20180908 /\


        /// <summary>
        /// Represents system name of Send Notification Message To IT support
        /// </summary>
        public const string ScheduleTaskMSPSentWalletSvcNotification = "ScheduleTask.MSP_SentWalletSvcNotification" ;   //Tony Liew 20181003 MSP-151
