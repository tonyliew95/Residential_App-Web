namespace Nop.Core.Domain.Customers
{
    ...
    /// <summary>
    /// Customer transaction password changed event
    /// </summary>
    public class CustomerTransactionPasswordChangedEvent
    {
        /// <summary>
        /// Ctor
        /// </summary>
        /// <param name="password">Password</param>
        public CustomerTransactionPasswordChangedEvent(CustomerTransactionPassword password)
        {
            this.Password = password;
        }
        ...
        /// Customer password
        /// </summary>
        public CustomerTransactionPassword Password { get; private set; }
    }
}