...
namespace Nop.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        /// <summary>
        ///  Gets or sets the user IsMember
        /// </summary>
        public bool IsMember { get; set; }

        /// <summary>
        /// Gets or sets the date and time when account locked during fail to attempt login
        /// </summary>
        public DateTime? AccountLockDateUtc { get; set; }

        /// <summary>
        /// Gets or sets the UpdatedBy by (CustomerId)
        /// </summary>
        public int? UpdatedBy { get; set; }          //LeeChurn 20181031 MSP-409

        /// <summary>
        /// Gets or sets the UpdatedOnUtc (DateTime in UTC) by (CustomerId)
        /// </summary>
        public DateTime? UpdatedOnUtc { get; set; }  //LeeChurn 20181031 MSP-409
