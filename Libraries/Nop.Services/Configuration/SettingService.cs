...
namespace Nop.Services.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        private readonly IRepository<MSP_Setting> _mspsettingRepository;// Tony Liew 20181204 MDT-122 
        ...
        public SettingService(IStaticCacheManager cacheManager, 
            ...
            IRepository<MSP_Setting> mspsettingRepository// Tony Liew 20181204 MDT-122 \/
            )
        {
            this._cacheManager = cacheManager;
            this._eventPublisher = eventPublisher;
            this._settingRepository = settingRepository;
            this._mspsettingRepository = mspsettingRepository;// Tony Liew 20181204 MDT-122 \/
        }
        ...
        /// <summary>
        /// Gets all MSP settings
        /// </summary>
        /// <returns>Settings</returns>
        public virtual IList<MSP_Setting> GetMSP_Settings()
        {
            var query = from s in _mspsettingRepository.Table
                        orderby s.Id, s.SettingKey
                        select s;
            var settings = query.ToList();
            return settings;
        ...
        /// <summary>
        /// Updates a msp setting
        /// </summary>
        /// <param name="setting">Setting</param>
        public virtual void UpdateMSPSetting(MSP_Setting setting)
        {
            if (setting == null)
                throw new ArgumentNullException(nameof(setting));

            _mspsettingRepository.Update(setting);
        ...
        /// <param name="settingId">Setting identifier</param>
        /// <returns>Setting</returns>
        public virtual MSP_Setting GetMspSettingById(int settingId)
        {
            if (settingId == 0)
                return null;

            return _mspsettingRepository.GetById(settingId);
        }
        // Tony Liew 20181204 MDT-122 /\
