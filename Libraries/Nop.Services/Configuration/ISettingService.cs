...
namespace Nop.Services.Configuration
{
    ...
    public partial interface ISettingService
    {
        ...
        /// </summary>
        /// <returns>Settings</returns>
        IList<MSP_Setting> GetMSP_Settings(); //Tony Liew 20181204 MDT-122
        ...
        /// <param name="settingId">Setting identifier</param>
        /// <returns>Setting</returns>
        MSP_Setting GetMspSettingById(int settingId);// Tony Liew 20181204 MDT-122

        /// <summary>
        /// Updates a msp setting
        /// </summary>
        /// <param name="setting">Setting</param>
        void UpdateMSPSetting(MSP_Setting setting);// Tony Liew 20181204 MDT-122
