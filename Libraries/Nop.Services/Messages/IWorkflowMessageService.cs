...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        #region Update Email
        /// <summary>
        /// Sends 'New MSP customer' notification message to a store owner
        /// </summary>
        /// <param name="customer">Customer instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int MSP_SendCustomerUpdateEmailMessage(Customer customer, int languageId, List<Tuple<string, string>> Settings, string Template); //20180816 LeeChurn MSP-61
        #endregion
        ...
        /// <param name="Settings">Email template tag e.g.: MSP_CustomerSupportEmail, MSP_SecurityAnswerEmailURL and etc</param>
        /// <param name="messageTemplateName">Refer Nop.Core.Domain.Messages.MessageTemplateSystemNames</param>
        /// <returns></returns>
        int GenericSendEmailNotification(Customer customer, int languageId, List<Tuple<string, string>> Settings, string messageTemplateName);
        #endregion
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendNotificationToITSupport(Tuple<string> IT_Support, int languageId); //Tony Liew 20181003 MSP-151
