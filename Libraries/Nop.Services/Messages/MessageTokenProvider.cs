...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected virtual string GetStoreUrl(int storeId = 0, bool removeTailingSlash = true)
        {
            ...
            //Url / problem defination 2 other web interface
            if (url.EndsWith("/"))
        ...
        public virtual void AddCustomerTokens(IList<Token> tokens, Customer customer)
        {
            ...
            var accountActivationUrl = $"{GetStoreUrl()}{GetUrlHelper().RouteUrl("MSP_PasswordRecoveryConfirm", new { token = customer.GetAttribute<string>(SystemCustomerAttributeNames.AccountActivationToken), email = customer.Email })}";
        ...
        public virtual void AddForgotPasswordTokens(IList<Token> tokens, Customer customer, Guid GeneratedReturnTokenID)
        {
            tokens.Add(new Token("Customer.Email", customer.Email));
            tokens.Add(new Token("Customer.Username", customer.Username));
            tokens.Add(new Token("Customer.FullName", customer.GetFullName()));
            ...
            var customAttributesXml = customer.GetAttribute<string>(SystemCustomerAttributeNames.CustomCustomerAttributes);
            tokens.Add(new Token("MSP_Customer.PasswordRecovery", _customerAttributeFormatter.FormatAttributes(customAttributesXml), true));

            //note: we do not use SEO friendly URLS for these links because we can get errors caused by having .(dot) in the URL (from the email address)
            var MSPpasswordRecoveryUrl = $"{GetStoreUrl()}{GetUrlHelper().RouteUrl("MSP_PasswordRecoveryConfirm", new { token = customer.GetAttribute<string>(SystemCustomerAttributeNames.PasswordRecoveryToken), email = customer.Email })}";

            //tokens.Add(new Token("Customer.PasswordRecoveryURL", passwordRecoveryUrl, true));
            tokens.Add(new Token("Customer.PasswordRecoveryURL", MSPpasswordRecoveryUrl, true));
        ...
        //LeeChurn 20180828 MSP-26 \/ redundant - not needed
        //public virtual void AddAcctActivationTokens(IList<Token> tokens, Customer customer, List<Tuple<string, string>> Settings)  //20180810 LeeChurn MSP-26
        //{
        //    tokens.Add(new Token("Customer.Email", customer.Email));
        //    tokens.Add(new Token("Customer.Username", customer.Username));
        //    tokens.Add(new Token("Customer.FullName", customer.GetFullName()));
        ...
        //    {
        //        if (setting.Item1== "MSP_AcctActivationURL")
        //        {
        //            tokens.Add(new Token(setting.Item1, GetStoreUrl()+setting.Item2+customer.CustomerGuid, true));
        //        }
        //        else if (setting.Item1 == "MSP_CustomerSupportEmail")
        //        {
        //            tokens.Add(new Token(setting.Item1, setting.Item2, true));
        //        }
        //    }
        //
        //    //tokens.Add(new Token("Customer.PasswordRecoveryURL", passwordRecoveryUrl, true));
        ...
        public virtual void ChangeTrxPwdTokens(IList<Token> tokens, Customer customer, Guid GeneratedReturnTokenID, List<Tuple<string, string>> Settings)
        {
            tokens.Add(new Token("Customer.Email", customer.Email));
            tokens.Add(new Token("Customer.Username", customer.Username));
            tokens.Add(new Token("Customer.FullName", customer.GetFullName()));
            ...
            var customAttributesXml = customer.GetAttribute<string>(SystemCustomerAttributeNames.CustomCustomerAttributes);
            tokens.Add(new Token("MSP_Customer.ChangeTransactionPassword", _customerAttributeFormatter.FormatAttributes(customAttributesXml), true));
            
            foreach (var setting in Settings)
            {
                if (setting.Item1 == "MSP_ChangeTrxPwdURL")
                {
                    tokens.Add(new Token(setting.Item1, GetStoreUrl() + setting.Item2 + customer.CustomerGuid, true));
                }
                else if (setting.Item1 == "MSP_CustomerSupportEmail")
        ...
        public virtual void ChangePasswordTokens(IList<Token> tokens, Customer customer, List<Tuple<string, string>> Settings, Guid GeneratedReturnTokenID)  //20180816 wailiang MSP-9
        {
            tokens.Add(new Token("Customer.Email", customer.Email));
            tokens.Add(new Token("Customer.Username", customer.Username));
            tokens.Add(new Token("Customer.FullName", customer.GetFullName()));
            ...
            var customAttributesXml = customer.GetAttribute<string>(SystemCustomerAttributeNames.CustomCustomerAttributes);
            tokens.Add(new Token("MSP_Customer.ChangePassword", _customerAttributeFormatter.FormatAttributes(customAttributesXml), true));

            //note: we do not use SEO friendly URLS for these links because we can get errors caused by having .(dot) in the URL (from the email address)
            //var MSPpasswordRecoveryUrl = $"{GetStoreUrl()}{GetUrlHelper().RouteUrl("MSP_PasswordRecoveryConfirm", new { token = customer.GetAttribute<string>(SystemCustomerAttributeNames.ChangePasswordToken), email = customer.Email })}";
            //tokens.Add(new Token("Customer.PasswordRecoveryURL", MSPpasswordRecoveryUrl, true));
            ...
            foreach (var setting in Settings)
            {
                if (setting.Item1 == "MSP_ChangePasswordURL")
                {
                    tokens.Add(new Token(setting.Item1, storeUrl + setting.Item2 + customer.CustomerGuid, true));
                }
                else if (setting.Item1 == "MSP_CustomerSupportEmail")
                {
                    tokens.Add(new Token(setting.Item1, setting.Item2, true));
        ...
        public virtual void AddCustomerVerifyUpdateEmailTokens(IList<Token> tokens, Customer customer, List<Tuple<string, string>> Settings)  //20180810 LeeChurn MSP-26
        {
            tokens.Add(new Token("Customer.Email", customer.Email));
            tokens.Add(new Token("Customer.Username", customer.Username));
            tokens.Add(new Token("Customer.FullName", customer.GetFullName()));
            ...
            foreach (var setting in Settings)
            {
                if (setting.Item1 == "MSP_UpdateEmailVerifyURL")
                {
                    tokens.Add(new Token(setting.Item1, setting.Item2, true));
                }
                else if (setting.Item1 == "MSP_CustomerSupportEmail")
                ...
                else if (setting.Item1 == "Customer.NewEmail")
                {
                    tokens.Add(new Token(setting.Item1, setting.Item2, true));
                }
            }
        ...
        /// <summary>
        /// add token into email template
        /// </summary>
        /// <param name="tokens"></param>
        /// <param name="customer"></param>
        /// <param name="Settings"></param>
        public void GenericSendMessage(IList<Token> tokens, Customer customer, List<Tuple<string, string>> Settings)
        {
            tokens.Add(new Token("Customer.Email", customer.Email));
            tokens.Add(new Token("Customer.Username", customer.Username));
            tokens.Add(new Token("Customer.FullName", customer.GetFullName()));
