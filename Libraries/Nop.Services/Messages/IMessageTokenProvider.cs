...
namespace Nop.Services.Messages
{
    ...
    public partial interface IMessageTokenProvider
    {
        ...
        #region "MSP"
        /// <summary>
        /// Add Forgotten Password tokens
        /// </summary>
        /// <param name="tokens">List of already added tokens</param>
        /// <param name="customer">Customer</param>
        /// <param name="GeneratedReturnTokenID">Guid</param>
        void AddForgotPasswordTokens(IList<Token> tokens, Customer customer, Guid GeneratedReturnTokenID);
        ...
        //void AddAcctActivationTokens(IList<Token> tokens, Customer customer, List<Tuple<string,string>> Settings);
        //LeeChurn 20180828 MSP-26 /\ redundant - not needed

        /// <summary>
        /// Change Transaction Password Tokens
        /// </summary>
        /// <param name="tokens"></param>
        /// <param name="customer"></param>
        /// <param name="GeneratedReturnTokenID"></param>
        /// <param name="Settings"></param>
        void ChangeTrxPwdTokens(IList<Token> tokens, Customer customer, Guid GeneratedReturnTokenID, List<Tuple<string, string>> Settings);

        /// Add Change Password tokens
        /// </summary>
        /// <param name="tokens">List of already added tokens</param>
        /// <param name="customer">Customer</param>
        /// <param name="Settings">Settings</param>
        void ChangePasswordTokens(IList<Token> tokens, Customer customer, List<Tuple<string, string>> Settings, Guid GeneratedReturnTokenID); //wailiang 20180816 MSP-9
        ...
        /// <param name="customer">Customer</param>
        /// <param name="Settings">Settings</param>
        void AddCustomerVerifyUpdateEmailTokens(IList<Token> tokens, Customer customer, List<Tuple<string, string>> Settings); //LeeChurn 20180821 MSP-61

        /// <summary>
        /// Generic function to add token into email template
        /// WilliamHo 20180822
        /// </summary>
        /// <param name="tokens"></param>
        /// <param name="customer"></param>
        /// <param name="Settings"></param>
        void GenericSendMessage(IList<Token> tokens, Customer customer, List<Tuple<string, string>> Settings);
        #endregion
    }
}
