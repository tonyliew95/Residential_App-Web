...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        private readonly ILocalizationService _localizationService; //Jerry 20181218 MDT-158
        ...
        public ExportManager(ICategoryService categoryService,
            ...
            , ILocalizationService localizationService //Jerry 20181218 MDT-158
            )
        {
            ...
            this._localizationService = localizationService; //Jerry 20181218 MDT-158
        }
        ...
        #region Export [Deposit Reward History List] to TXT

        /// <summary>
        /// Export [Deposit Reward History List] to TXT
        /// </summary>
        /// <param name="list">List</param>
        /// <returns>Result in TXT (string) format</returns>
        public virtual string ExportDepositRewardHistoryListToTxt(IList<DepositRewardHistoryCustom> list) //Jerry 20181218 MDT-158
        {
            if (list == null)
            ...
            var sb = new StringBuilder();
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.Username"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.Date"));
            sb.Append(separator);
            /*sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.ContributedBy"));  //Atiqah 20190221 MDT-257
            sb.Append(separator);*/
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.DepositAmount"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.DepositReturned"));
            sb.Append(separator);
            /*sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.DepositReward"));  //Atiqah 20190221 MDT-257
            sb.Append(separator);*/
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.DepositReturnedReward"));  //Atiqah 20190221 MDT-257
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.DepositOverflowReward"));  //Atiqah 20190221 MDT-257
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.ExtraReward"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.TotalReward"));
            //Atiqah 20190221 MDT-257 \/
            /*sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.SelfScorePct"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.SelfScore"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.TeamScorePct"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.TransactionList.DepositRewardHistory.Fields.TeamScorePct"));*/
            //Atiqah 20190221 MDT-257 /\
            sb.Append(Environment.NewLine); //new line
            ...
            foreach (var item in list)
            {
                ...
                sb.Append(item.Date);
                sb.Append(separator);
                /*sb.Append(item.ContributedBy);  //Atiqah 20190221 MDT-257
                sb.Append(separator);*/
                sb.Append(item.Deposit_Amt);
                sb.Append(separator);
                sb.Append(item.Deposit_Returned);
                sb.Append(separator);
                /*sb.Append(item.Deposit_Reward);  //Atiqah 20190221 MDT-257
                sb.Append(separator);*/
                sb.Append(item.Deposit_Returned_Reward);  //Atiqah 20190221 MDT-257
                sb.Append(separator);
                sb.Append(item.Deposit_Overflow_Reward);  //Atiqah 20190221 MDT-257
                sb.Append(separator);
                sb.Append(item.Extra_Reward);
                sb.Append(separator);
                sb.Append(item.Total_Reward);
                //Atiqah 20190221 MDT-257 \/
                /*sb.Append(separator);
                sb.Append(item.SelfScore_Pct);
                sb.Append(separator);
                sb.Append(item.SelfScore);
                sb.Append(separator);
                sb.Append(item.TeamScore_Pct);
                sb.Append(separator);
                sb.Append(item.TeamScore);*/
                //Atiqah 20190221 MDT-257 /\
                sb.Append(Environment.NewLine); //new line
            }
        ...
        #endregion Export [Deposit Reward History List] to TXT

        #region Export [Top up, Agency Fee and Withdrawal Report] to TXT

        /// <summary>
        /// Export [Top up, Agency Fee and Withdrawal Daily Report] to TXT
        /// </summary>
        /// <param name="list">List</param>
        /// <returns>Result in TXT (string) format</returns>
        public virtual string ExportTopUpDepositWithdrawalReportToTxt(IList<TopupDepositWithdrawalDailyReportCustom> list) //Jerry 20181219 MDT-159
        {
            if (list == null)
                throw new ArgumentNullException(nameof(list));
            ...
            var sb = new StringBuilder();
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.Date"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.TopUpDepositWithdrawal.Fields.MbtcTopup"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.MbtcDeposit"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.TopUpDepositWithdrawal.Fields.MbtcWithdrawal"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.TopUpDepositWithdrawal.Fields.MbtcBalance"));
            sb.Append(Environment.NewLine); //new line

            foreach (var item in list)
            {
                sb.Append(item.TrxDate);
                sb.Append(separator);
                sb.Append(item.Topup_mBTC);
                sb.Append(separator);
                sb.Append(item.Deposit_mBTC);
                sb.Append(separator);
                sb.Append(item.Withdrawal_mBTC);
                sb.Append(separator);
                sb.Append(item.Balance_mBTC);
                sb.Append(Environment.NewLine); //new line
            }
        ...
        /// <summary>
        /// Export [Top up, Agency Fee and Withdrawal Weekly Report] to TXT
        /// </summary>
        /// <param name="list">List</param>
        /// <returns>Result in TXT (string) format</returns>
        public virtual string ExportTopUpDepositWithdrawalReportToTxt(IList<TopupDepositWithdrawalWeeklyReportCustom> list) //Jerry 20181219 MDT-159
        {
            if (list == null)
                throw new ArgumentNullException(nameof(list));
            ...
            var sb = new StringBuilder();
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.StartDate"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.EndDate"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.TopUpDepositWithdrawal.Fields.MbtcTopup"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.MbtcDeposit"));
            ...
            foreach (var item in list)
            {
                sb.Append(item.WeekStart);
                sb.Append(separator);
                sb.Append(item.WeekEnd);
                sb.Append(separator);
                sb.Append(item.Topup_mBTC);
                sb.Append(separator);
                sb.Append(item.Deposit_mBTC);
        ...
        /// <summary>
        /// Export [Top up, Agency Fee and Withdrawal Monthly Report] to TXT
        /// </summary>
        /// <param name="list">List</param>
        /// <returns>Result in TXT (string) format</returns>
        public virtual string ExportTopUpDepositWithdrawalReportToTxt(IList<TopupDepositWithdrawalMonthlyReportCustom> list) //Jerry 20181219 MDT-159
        {
            if (list == null)
                throw new ArgumentNullException(nameof(list));
            ...
            var sb = new StringBuilder();
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.Month"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.Year"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.TopUpDepositWithdrawal.Fields.MbtcTopup"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.MbtcDeposit"));
        ...
        #endregion Export [Top up, Agency Fee and Withdrawal Report] to TXT

        #region Export [Agency Fee, Agency Fee Returned and Task Report] to TXT

        /// <summary>
        /// Export [Agency Fee, Agency Fee Returned and Task Daily Report] to TXT
        /// </summary>
        /// <param name="list">List</param>
        /// <returns>Result in TXT (string) format</returns>
        public virtual string ExportDepositDepositReturnedConsumptionReportToTxt(IList<DepositDepositReturnedConsumptionDailyReportCustom> list) //Jerry 20181219 MDT-160
        {
            if (list == null)
                throw new ArgumentNullException(nameof(list));
            ...
            sb.Append(_localizationService.GetResource("Admin.Report.Fields.MbtcDeposit"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.DepositDepositReturnedConsumption.Fields.MbtcDepositReturn"));
            sb.Append(separator);
            sb.Append(_localizationService.GetResource("Admin.Report.DepositDepositReturnedConsumption.Fields.MbtcConsumption"));
            sb.Append(Environment.NewLine); //new line
            ...
            foreach (var item in list)
            {
                ...
                sb.Append(item.Deposit_Amt);
                sb.Append(separator);
                sb.Append(item.Offset_Amt);
                sb.Append(separator);
                sb.Append(item.Consumption_Amt);
                sb.Append(Environment.NewLine); //new line
            }
        ...
        /// <summary>
        /// Export [Agency Fee, Agency Fee Returned and Task Weekly Report] to TXT
        /// </summary>
        /// <param name="list">List</param>
        /// <returns>Result in TXT (string) format</returns>
        public virtual string ExportDepositDepositReturnedConsumptionReportToTxt(IList<DepositDepositReturnedConsumptionWeeklyReportCustom> list) //Jerry 20181219 MDT-160
        {
            if (list == null)
                throw new ArgumentNullException(nameof(list));
        ...
        /// <summary>
        /// Export [Agency Fee, Agency Fee Returned and Task Monthly Report] to TXT
        /// </summary>
        /// <param name="list">List</param>
        /// <returns>Result in TXT (string) format</returns>
        public virtual string ExportDepositDepositReturnedConsumptionReportToTxt(IList<DepositDepositReturnedConsumptionMonthlyReportCustom> list) //Jerry 20181219 MDT-160
        {
            if (list == null)
                throw new ArgumentNullException(nameof(list));
        ...
        #endregion Export [Agency Fee, Agency Fee Returned and Task Report] to TXT
