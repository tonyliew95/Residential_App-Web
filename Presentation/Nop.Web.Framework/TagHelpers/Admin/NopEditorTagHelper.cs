...
namespace Nop.Web.Framework.TagHelpers.Admin
{
    ...
    public class NopEditorTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //object htmlAttributes = null; //wailiang 20181224 MDT-150
            if (string.IsNullOrEmpty(RenderFormControlClass) && For.Metadata.ModelType.Name.Equals("String") || renderFormControlClass)
                //htmlAttributes = new {@class = "form-control"}; //wailiang 20181224 MDT-150
                htmlAttributes.Add("class", "form-control"); //wailiang 20181224 MDT-150
