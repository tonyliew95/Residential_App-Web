...
namespace Nop.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private readonly IRepository<MSP_Setting> _setting;
        ...
        public WebWorkContext(
            ...
            IRepository<MSP_Setting> setting,
        ...
        public virtual Customer CurrentCustomer
        {
            get
            {
                ...
                //Commend by wailiang 20180814 MSP-52
                //if (customer == null || customer.Deleted || !customer.Active || customer.RequireReLogin)
                //{
                //    //get guest customer
                ...
                string GuestCustomerUsername = _baseHelper.getSettingValueByKey("RES_GuestCustomerUsername", "searchengine");
                Guid GuestCustomerGuid = Guid.Parse(_customerService.GetCustomerGuidByUsername(GuestCustomerUsername).ToString());
                ...
                if (customer == null || customer.Deleted || !customer.Active || customer.RequireReLogin)
                {
                    ...
                    var customerByCookie = _customerService.GetCustomerByGuid(GuestCustomerGuid);
                    if (customerByCookie != null && !customerByCookie.IsRegistered())
                        customer = customerByCookie;
                }
