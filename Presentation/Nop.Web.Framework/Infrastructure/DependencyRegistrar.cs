...
using Nop.Services.Msp.Cryptography;
...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<MemberTreeServices>().As<IMemberTreeServices>().InstancePerLifetimeScope();

            builder.RegisterType<ActionContextAccessor>().As<IActionContextAccessor>().InstancePerLifetimeScope();

            #region MSP Builder
            builder.RegisterType<MSP_DepositService>().As<IMSP_DepositService>().InstancePerLifetimeScope();//EricTan 20180717 - MSP builder
            builder.RegisterType<MspHelper>().As<IMspHelper>().InstancePerLifetimeScope(); //Jerry 20180814 MSP-45
            builder.RegisterType<AnnouncementsService>().As<IAnnouncementsService>().InstancePerLifetimeScope(); //WilliamHo 20180829 MSP-99
            //builder.RegisterType<SecurityQuestionManagementServices>().As<ISecurityQuestionManagementService>().InstancePerLifetimeScope(); //Tony Liew 20180828 MSP-47 //Atiqah 20190131 MDT-205
            builder.RegisterType<TransactionService>().As<ITransactionService>().InstancePerLifetimeScope(); //Atiqah 20180829 MSP-94
            builder.RegisterType<ReportService>().As<IReportService>().InstancePerLifetimeScope(); //Tony Liew 20180828 MSP-92
			builder.RegisterType<GrcAnnouncementsService>().As<IGrcAnnouncementsService>().InstancePerLifetimeScope(); // WKK 20181227 MDT-183
            builder.RegisterType<RoadMapService>().As<IRoadMapService>().InstancePerLifetimeScope(); //wailiang 20181231 MDT-149
            #endregion

            #region Residential Builder
            builder.RegisterType<CryptographyService>().As<ICryptographyService>().InstancePerLifetimeScope(); //William Ho 20190310
            builder.RegisterType<IncidentServices>().As<IIncidentServices>().InstancePerLifetimeScope();//Tony Liew 20190306 RDT-116
            builder.RegisterType<ValidatorHelper>().As<IValidatorHelper>().InstancePerLifetimeScope(); //Tony Liew 20190308 RDT-118
            builder.RegisterType<FormatingHelper>().As<IFormatingHelper>().InstancePerLifetimeScope(); //Tony Liew 20190308 RDT-118
            builder.RegisterType<BaseHelper>().As<IBaseHelper>().InstancePerLifetimeScope(); //Tony Liew 20190308 RDT-118
            builder.RegisterType<ProfileServices>().As<IProfileServices>().InstancePerLifetimeScope(); // Tony Liew 20190315 RDT-65 
            builder.RegisterType<FamilyTenantServices>().As<IFamilyTenantServices>().InstancePerLifetimeScope(); //Tony Liew 20190403 RDT-175 
            builder.RegisterType<AnnouncementServices>().As<IAnnouncementServices>().InstancePerLifetimeScope(); //WKK 20190315 RDT-121
            builder.RegisterType<VisitorService>().As<IVisitorService>().InstancePerLifetimeScope(); //WKK 20190411 RDT-189 [API] Visitor - Record History Listing
            builder.RegisterType<FacilityServices>().As<IFacilityServices>().InstancePerLifetimeScope(); //Tony Liew 20190418 RDT-202 
            #endregion
