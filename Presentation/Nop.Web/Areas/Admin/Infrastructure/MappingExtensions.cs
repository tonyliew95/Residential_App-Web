...
namespace Nop.Web.Areas.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        //public static SecurityQuestionViewModel ToSecurityModel(this MSP_SecurityQuestion entity)
        //{
        //    return entity.MapTo<MSP_SecurityQuestion, SecurityQuestionViewModel>();
        //}

        //public static MSP_SecurityQuestion ToSecurityEntity(this SecurityQuestionViewModel model)
        //{
        //    return model.MapTo<SecurityQuestionViewModel, MSP_SecurityQuestion>();
        //}

        //public static MSP_SecurityQuestion ToSecurityEntity(this SecurityQuestionViewModel model, MSP_SecurityQuestion destination)
        //{
        //    return model.MapTo(destination);
        //}
        //Atiqah 20190131 MDT-205/\
        ...
        //WilliamHo 20180903 MSP-99 \/
        #region Announcement
        //announcement items
        public static AnnouncementsModel ToAnnouncementModel(this MSP_Announce_Content entity)
        {
            return entity.MapTo<MSP_Announce_Content, AnnouncementsModel>();
        }

        public static MSP_Announce_Content ToAnnouncementEntity(this AnnouncementsModel model)
        {
            return model.MapTo<AnnouncementsModel, MSP_Announce_Content>();
        }

        public static MSP_Announce_Content ToAnnouncementEntity(this AnnouncementsModel model, MSP_Announce_Content destination)
        {
            return model.MapTo(destination);
        }
		#endregion

		#region Duplicate Model wailiang 20181226 MDT-134
		//wailiang 20181218 MDT-134 \/
		#region Announcement View Only
		//public static AnnouncementsViewOnlyModel ToAnnouncementViewOnlyModel(this MSP_Announce_Content entity)
		//{
		//    return entity.MapTo<MSP_Announce_Content, AnnouncementsViewOnlyModel>();
		//}

		//public static MSP_Announce_Content ToAnnouncementViewOnlyEntity(this AnnouncementsViewOnlyModel model)
		//{
		//    return model.MapTo<AnnouncementsViewOnlyModel, MSP_Announce_Content>();
		//}

		//public static MSP_Announce_Content ToAnnouncementViewOnlyEntity(this AnnouncementsViewOnlyModel model, MSP_Announce_Content destination)
		//{
		//    return model.MapTo(destination);
		//}
		#endregion
		...
		//WKK 20181228 MDT-183 \/
		#region GrcAnnouncement
		public static GrcAnnouncementsModel ToGrcAnnouncementModel(this MSP_GrcAnnouncement entity)
		{
			return entity.MapTo<MSP_GrcAnnouncement, GrcAnnouncementsModel>();
		}

		public static MSP_GrcAnnouncement ToGrcAnnouncementEntity(this GrcAnnouncementsModel model)
		{
			return model.MapTo<GrcAnnouncementsModel, MSP_GrcAnnouncement>();
		}

		public static MSP_GrcAnnouncement ToGrcAnnouncementEntity(this GrcAnnouncementsModel model, MSP_GrcAnnouncement destination)
		{
			return model.MapTo(destination);
		}
		#endregion
		...
		#region Promotion
		public static PromotionsModel ToPromotionModel(this MSP_Announce_Content entity)
        {
            return entity.MapTo<MSP_Announce_Content, PromotionsModel>();
        }

        public static MSP_Announce_Content ToPromotionEntity(this PromotionsModel model)
        {
            return model.MapTo<PromotionsModel, MSP_Announce_Content>();
        }

        public static MSP_Announce_Content ToPromotionEntity(this PromotionsModel model, MSP_Announce_Content destination)
        {
            return model.MapTo(destination);
        }
        #endregion

        #region Duplicate Model wailiang 20181226 MDT-150
        //wailiang 20181219 MDT-150 \/
        #region Promotion View Only
        //public static PromotionsViewOnlyModel ToPromotionViewOnlyModel(this MSP_Announce_Content entity)
        //{
        //    return entity.MapTo<MSP_Announce_Content, PromotionsViewOnlyModel>();
        //}

        //public static MSP_Announce_Content ToPromotionEntity(this PromotionsViewOnlyModel model)
        //{
        //    return model.MapTo<PromotionsViewOnlyModel, MSP_Announce_Content>();
        //}

        //public static MSP_Announce_Content ToPromotionEntity(this PromotionsViewOnlyModel model, MSP_Announce_Content destination)
        //{
        //    return model.MapTo(destination);
        //}
        #endregion
        ...
        #region UserGuides
        public static UserGuidesModel ToUserGuidesModel(this MSP_Announce_Content entity)
        {
            return entity.MapTo<MSP_Announce_Content, UserGuidesModel>();
        }

        public static MSP_Announce_Content ToUserGuidesEntity(this UserGuidesModel model)
        {
            return model.MapTo<UserGuidesModel, MSP_Announce_Content>();
        }

        public static MSP_Announce_Content ToUserGuidesEntity(this UserGuidesModel model, MSP_Announce_Content destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        ...
        #region Duplicate Model wailiang 20181226 MDT-151
        //wailiang 20181219 MDT-151 \/
        #region UserGuides View Only
        //public static UserGuidesViewOnlyModel ToUserGuidesViewOnlyModel(this MSP_Announce_Content entity)
        //{
        //    return entity.MapTo<MSP_Announce_Content, UserGuidesViewOnlyModel>();
        //}

        //public static MSP_Announce_Content ToUserGuidesEntity(this UserGuidesViewOnlyModel model)
        //{
        //    return model.MapTo<UserGuidesViewOnlyModel, MSP_Announce_Content>();
        //}

        //public static MSP_Announce_Content ToUserGuidesEntity(this UserGuidesViewOnlyModel model, MSP_Announce_Content destination)
        //{
        //    return model.MapTo(destination);
        //}
        #endregion
        ...
        //wailiang 20180921 MSP-98 \/
        #region TeamConsumptionReward
        public static ConsumptionRewardModel ToModel(this ConsumptionRewardHistoryCustom entity)
        {
            return entity.MapTo<ConsumptionRewardHistoryCustom, ConsumptionRewardModel>();
        }

        public static ConsumptionRewardHistoryCustom ToEntity(this ConsumptionRewardModel model)
        {
            return model.MapTo<ConsumptionRewardModel, ConsumptionRewardHistoryCustom>();
        }

        public static ConsumptionRewardHistoryCustom ToEntity(this ConsumptionRewardModel model, ConsumptionRewardHistoryCustom destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        //wailiang 20180906 MSP-98 /\

        //Atiqah 20180906 MSP-94 \/
        #region Deposit
        //announcement items
        public static DepositModel ToModel(this MSP_Deposit entity)
        {
            return entity.MapTo<MSP_Deposit, DepositModel>();
        }

        public static MSP_Deposit ToEntity(this DepositModel model)
        {
            return model.MapTo<DepositModel, MSP_Deposit>();
        }

        public static MSP_Deposit ToEntity(this DepositModel model, MSP_Deposit destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        ...
        //wailiang 20180910 MSP-95 \/
        #region Withdrawal
        public static WithdrawalModel ToModel(this MSP_Mbtc_Withdrawal entity)
        {
            return entity.MapTo<MSP_Mbtc_Withdrawal, WithdrawalModel>();
        }

        public static MSP_Mbtc_Withdrawal ToEntity(this WithdrawalModel model)
        {
            return model.MapTo<WithdrawalModel, MSP_Mbtc_Withdrawal>();
        }

        public static MSP_Mbtc_Withdrawal ToEntity(this WithdrawalModel model, MSP_Mbtc_Withdrawal destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        ...
        #region Video Guides
        public static VideoGuideModel ToVideoGuideModel(this MSP_Announce_Content entity)
        {
            return entity.MapTo<MSP_Announce_Content, VideoGuideModel>();
        }

        public static MSP_Announce_Content ToVideoGuideEntity(this VideoGuideModel model)
        {
            return model.MapTo<VideoGuideModel, MSP_Announce_Content>();
        }

        public static MSP_Announce_Content ToVideoGuideEntity(this VideoGuideModel model, MSP_Announce_Content destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        ...
        #region Incidents
        public static IncidentsModel ToIncidentModel(this Trx_Incident entity) //wailiang 20190314 RDT-127
        {
            return entity.MapTo<Trx_Incident, IncidentsModel>();
        }

        public static Trx_Incident ToIncidentEntity(this IncidentsModel model)
        {
            return model.MapTo<IncidentsModel, Trx_Incident>();
        }

        public static Trx_Incident ToIncidentEntity(this IncidentsModel model, Trx_Incident destination)
        {
            return model.MapTo(destination);
        }
        #endregion
