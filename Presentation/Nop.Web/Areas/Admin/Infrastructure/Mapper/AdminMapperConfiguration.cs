...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IMapperProfile
    {
        public AdminMapperConfiguration()
        {
            ...
            //MSP mapper \/
            #region Announcement
            //WilliamHo 20180909 MSP-99
            /*
            * Details: CreateMap<source,destination>, ignore destination attribute for mapping
            * Map AnnouncementsModel to MSP_Announce_Content, exclude the destination's attribute to map
            * Reason: AnnouncementsModel do not have these attributes to map, 
            * otherwise it will hit "Missing type map configuration or unsupported mapping", means FAIL to map. 
            */
            CreateMap<AnnouncementsModel, MSP_Announce_Content>()
                ...
                .ForMember(dest => dest.UpdatedOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.PublishedOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.ExpiredOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.ContentType, mo => mo.Ignore());
            //Map MSP_Announce_Content to AnnouncementsModel by exclude AnnouncementsModel's attribute
            CreateMap<MSP_Announce_Content, AnnouncementsModel>()
                .ForMember(dest => dest.IsPublished, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
                .ForMember(dest => dest.StartDate, mo => mo.Ignore())
                .ForMember(dest => dest.EndDate, mo => mo.Ignore())
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
			...
			CreateMap<GrcAnnouncementsModel, MSP_GrcAnnouncement>()
				.ForMember(dest => dest.CreatedBy, mo => mo.Ignore())
				.ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore())
				.ForMember(dest => dest.UpdatedBy, mo => mo.Ignore())
				.ForMember(dest => dest.UpdatedOnUtc, mo => mo.Ignore())
				.ForMember(dest => dest.PublishedOnUtc, mo => mo.Ignore())
				.ForMember(dest => dest.ExpiredOnUtc, mo => mo.Ignore());
			CreateMap<MSP_GrcAnnouncement, GrcAnnouncementsModel>()
				.ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
				.ForMember(dest => dest.StartDate, mo => mo.Ignore())
				.ForMember(dest => dest.EndDate, mo => mo.Ignore())
				.ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            ...
            #region Security
            //Tony Liew 20180910 MSP-47
            /*
            * Details: CreateMap<source,destination>, ignore destination attribute for mapping
            * Map SecurityQuestionViewModel to MSP_SecurityQuestion, exclude the destination's attribute to map
            * Reason: AnnouncementsModel do not have these attributes to map, 
            * otherwise it will hit "Missing type map configuration or unsupported mapping", means FAIL to map. 
            */
            //Atiqah 20190131 MDT-205 \/
            //CreateMap<SecurityQuestionViewModel, MSP_SecurityQuestion>()
            //    .ForMember(dest => dest.Status, mo => mo.Ignore())
            //    .ForMember(dest => dest.Id, mo => mo.Ignore())
            //    .ForMember(dest => dest.Question, mo => mo.Ignore());

            //Map MSP_SecurityQuestion to SecurityQuestionViewModel by exclude SecurityQuestionViewModel's attribute
            //CreateMap<MSP_SecurityQuestion, SecurityQuestionViewModel>()
            //    .ForMember(dest => dest.Status, mo => mo.Ignore())
            //    .ForMember(dest => dest.QuestionID, mo => mo.Ignore())
            //    .ForMember(dest => dest.Question, mo => mo.Ignore())
            //    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            //Atiqah 20190131 MDT-205 /\
            #endregion
            ...
            CreateMap<PromotionsModel, MSP_Announce_Content>()
                .ForMember(dest => dest.Status, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedBy, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.UpdatedBy, mo => mo.Ignore())
                ...
                .ForMember(dest => dest.ExpiredOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.ContentType, mo => mo.Ignore());
            CreateMap<MSP_Announce_Content, PromotionsModel>()
                .ForMember(dest => dest.IsPublished, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
                .ForMember(dest => dest.StartDate, mo => mo.Ignore())
                .ForMember(dest => dest.EndDate, mo => mo.Ignore())
            ...
            CreateMap<UserGuidesModel, MSP_Announce_Content>()
                .ForMember(dest => dest.Status, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedBy, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.UpdatedBy, mo => mo.Ignore())
                ...
                .ForMember(dest => dest.ExpiredOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.ContentType, mo => mo.Ignore());
            CreateMap<MSP_Announce_Content, UserGuidesModel>()
                .ForMember(dest => dest.IsPublished, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
                .ForMember(dest => dest.StartDate, mo => mo.Ignore())
                .ForMember(dest => dest.EndDate, mo => mo.Ignore())
            ...
            CreateMap<VideoGuideModel, MSP_Announce_Content>()
                .ForMember(dest => dest.Status, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedBy, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.UpdatedBy, mo => mo.Ignore())
                ...
                .ForMember(dest => dest.ExpiredOnUtc, mo => mo.Ignore())
                .ForMember(dest => dest.ContentType, mo => mo.Ignore());
            CreateMap<MSP_Announce_Content, VideoGuideModel>()
                .ForMember(dest => dest.IsPublished, mo => mo.Ignore())
                .ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
                .ForMember(dest => dest.StartDate, mo => mo.Ignore())
                .ForMember(dest => dest.EndDate, mo => mo.Ignore())
            ...
            #region Incidents //wailiang 20190314 RDT-127
            CreateMap<IncidentsModel, Trx_Incident>()
                .ForMember(dest => dest.Title, mo => mo.Ignore())
                .ForMember(dest => dest.Inc_DateTime, mo => mo.Ignore())
                .ForMember(dest => dest.Inc_CategoryId, mo => mo.Ignore())
                .ForMember(dest => dest.Inc_ItemId, mo => mo.Ignore())
                .ForMember(dest => dest.Inc_TypeId, mo => mo.Ignore())
                .ForMember(dest => dest.Status, mo => mo.Ignore())
                .ForMember(dest => dest.Desc, mo => mo.Ignore());
            CreateMap<Trx_Incident, IncidentsModel>()
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            #endregion
            //MSP mapper /\
        }
