...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapLocalizedRoute("MSP_PasswordRecoveryConfirm", "MSP_forgotpasswordrecovery/confirm",
                new { controller = "AccountController", action = "ForgotPasswordEmailVerification" });
            ...
            routeBuilder.MapLocalizedRoute("TermsAndConditions", "termsandconditions",
                new { controller = "Common", action = "TermsAndConditions" });
        }
