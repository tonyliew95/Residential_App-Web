...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        public virtual IActionResult Login(bool? checkoutAsGuest)
        {
            ...
            //check if user have an active session, it will redirect to homepage even user try to request to login page
            //var isAuthenticated = Core.Infrastructure.EngineContext.Current.Resolve<IWorkContext>().CurrentCustomer.IsRegistered();
            //if(isAuthenticated) return Redirect(Url.Content("~/Admin"));
            //WilliamHo 20190117 MDT-680 /\
            ...
            if (ModelState.IsValid)
            {
                ...
                switch (loginResult)
                {
                    case CustomerLoginResults.Successful:
                        {
                            ...
                            //WilliamHo 20181119 \/
                            return Redirect(returnUrl); //force redirect user login to Admin homepage
                            //return RedirectToRoute("HomePage");
                            //WilliamHo 20181119 /\
                        }
                    ...
                    case CustomerLoginResults.LockedOut:
                        ...
                        break;
                    case CustomerLoginResults.IsMember:
                        ModelState.AddModelError("", _localizationService.GetResource("Account.Login.WrongCredentials.IsMember"));
                        break;
                    #region Commend Code wailiang 20181213 MDT-133 (Will Cause Issue in login)
                    //Atiqah 20181002 MSP-186 \/
                    //case CustomerLoginResults.NonAdmin:
                    //    ModelState.AddModelError("", _localizationService.GetResource("Account.Login.WrongCredentials.AdministratorNotFound"));
                    //    break;
                    //Atiqah 20181002 MSP-186 /\
                    #endregion
